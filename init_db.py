#!/usr/bin/env python3
"""
Database Initialization Script for Letter Management System
...
DB_CONFIG = {
    ...
    'password': os.environ.get('LMS_DB_PASSWORD', 'Siva03'),
    'autocommit': False
}

DB_NAME = os.environ.get('LMS_DB_NAME', 'letter_management')
        ...
        sample_users = [
            {
                ...
                'email': 'hod@letter_management.edu',
            ...
            },
            {
                ...
                'email': 'advisor@letter_management.edu',
                'department': 'computer science',
                'year': '1',
                'dob': '1980-05-20',
            ...
            },
            {
                ...
                'email': 'mentor@letter_management.edu',
                'department': 'computer science',
                'year': '1',
                'dob': '1985-08-10',
            ...
            },
            {
                ...
                'mentor_email': 'mentor@letter_management.edu',
...
def main():
    ...
    print("Initializing Letter Management System Database...")
    print("=" * 50)
