# Logging configuration for Letter Management System
...
def setup_logging(app):
    ...
    app_handler = logging.handlers.RotatingFileHandler(
        os.path.join(logs_dir, 'letter_management.log'),
    ...
    # Security logger
    security_logger = logging.getLogger('letter_management.security')
    security_logger.addHandler(security_handler)
    security_logger.setLevel(logging.INFO)
    
    # Database logger
    db_logger = logging.getLogger('letter_management.database')
    ...
    # Request logger
    request_logger = logging.getLogger('letter_management.requests')
