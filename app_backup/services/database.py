"""Database utilities and migration helpers for Letter Management System"""
    ...
    try:
        ...
        sample_users = [
            ...
            },
            {
                ...
                'email': 'admin@letter_management.edu',
        ...
        logger.info("Letter Management System - Sample Login Credentials")
