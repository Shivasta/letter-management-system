...
# Flask Configuration
SECRET_KEY = os.environ.get('LMS_SECRET_KEY', 'letter-management-secret-key-2025-secure')
...
APP_NAME = "Letter Management System"
...
MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER', 'noreply@lettermanagement.edu')
